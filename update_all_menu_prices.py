...
for price_data in menu_prices:
    ...
    try:
        ...
        if menu_price is not None:
            ...
            updates.append(f"menu_price: €{old_menu or 0} → €{menu_price}")
        ...
        if bottle_price is not None:
            ...
            updates.append(
                f"bottle_price: €{old_bottle or 0} → €{bottle_price}"
            )
        ...
        if updates:
            ...
            print(f"✅ [{cat_name}] {sku} - {item.name}")
...
print(f"Not found in database:      {len(not_found)} ⚠️")
print(f"Errors:                     {len(errors)} ❌")
print()

if not_found:
    print("⚠️  SKUs not found in database:")
...
print("🎉 All menu prices have been updated!")
print()
print("KEY POINTS:")
print("  • Draught beer prices = PER PINT")
print("  • Bottled beer prices = PER BOTTLE")
print("  • Spirit prices = PER SHOT (25ml/35ml)")
print("  • Wine: bottle_price + menu_price (glass)")
print("=" * 80)
