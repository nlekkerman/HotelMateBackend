"""
Create September 2024 stocktake by scaling October data
...
print("=" * 100)
print("CREATING SEPTEMBER 2024 STOCKTAKE")
print("=" * 100)
print()
...
try:
    ...
    print(f"✓ October 2024 period found")
...
print("Creating September 2024 period...")
sept_period, created = StockPeriod.create_monthly_period(hotel, 2024, 9)

if not created:
    print("⚠️  September 2024 period already exists!")
    ...
    print("✓ September 2024 period created")
...
sept_period.notes = "Created from October 2024 data using category scale factors"
sept_period.save()
