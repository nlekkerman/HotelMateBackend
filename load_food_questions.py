"""
Script to load Food multiple-choice questions into the quiz system
"""
import os
import sys
import django
...
def load_food_questions():
    """Load Food questions from JSON file"""
    
    # Read the JSON file
    json_path = "food_questions.json"
    ...
    if created:
        ...
        print("✅ Food category already exists")
    ...
    print(f"🍔 Total Food questions in database: {total}")
    print(f"\n🎯 Food category is ready!")


if __name__ == '__main__':
    print("🔄 Loading Food questions...")
    load_food_questions()
    print("✅ Done!")
