"""
Create October 2024 Snapshots with CORRECT SKUs and Close Period

This uses the actual SKUs that exist in the database with EXACT Excel values.
"""
...
# ========== DRAUGHT BEERS (Correct SKUs) ==========
EXCEL_DRAUGHT = [
    {'sku': 'D2133', 'full': Decimal('0.00'), 'partial': Decimal('40.00'), 'value': Decimal('68.25')},
    {'sku': 'D0007', 'full': Decimal('0.00'), 'partial': Decimal('79.00'), 'value': Decimal('137.25')},
    {'sku': 'D1004', 'full': Decimal('0.00'), 'partial': Decimal('0.00'), 'value': Decimal('0.00')},
    {'sku': 'D0004', 'full': Decimal('0.00'), 'partial': Decimal('0.00'), 'value': Decimal('0.00')},
    {'sku': 'D0012', 'full': Decimal('0.00'), 'partial': Decimal('0.00'), 'value': Decimal('0.00')},
    {'sku': 'D0011', 'full': Decimal('0.00'), 'partial': Decimal('5.00'), 'value': Decimal('13.60')},
    {'sku': 'D2354', 'full': Decimal('0.00'), 'partial': Decimal('304.00'), 'value': Decimal('763.73')},
    {'sku': 'D1003', 'full': Decimal('0.00'), 'partial': Decimal('198.00'), 'value': Decimal('419.69')},
    {'sku': 'D0008', 'full': Decimal('0.00'), 'partial': Decimal('26.50'), 'value': Decimal('57.34')},
    {'sku': 'D1022', 'full': Decimal('0.00'), 'partial': Decimal('296.00'), 'value': Decimal('652.04')},
    {'sku': 'D0006', 'full': Decimal('0.00'), 'partial': Decimal('93.00'), 'value': Decimal('204.86')},
    {'sku': 'D1258', 'full': Decimal('6.00'), 'partial': Decimal('39.75'), 'value': Decimal('1265.44')},
    {'sku': 'D0005', 'full': Decimal('0.00'), 'partial': Decimal('246.00'), 'value': Decimal('521.38')},
    {'sku': 'D0030', 'full': Decimal('0.00'), 'partial': Decimal('542.00'), 'value': Decimal('1208.04')},
]
...
def main():
    print("=" * 70)
    print("CREATE OCTOBER 2024 SNAPSHOTS & CLOSE PERIOD")
    print("=" * 70)
    ...
    try:
        ...
        if period.is_closed:
            ...
            period.save()
            print(f"\n📅 Reopened period: {period.period_name}")
    ...
    totals['D'] = update_category('D', 'Draught Beers', EXCEL_DRAUGHT, Decimal('5311.62'))
    ...
    if abs(grand_total - excel_grand_total) < Decimal('0.10'):
        print("\n✅ PERFECT MATCH!")
        status = "verified"
    ...
    if status == "verified":
        ...
        # Count snapshots
        snapshot_count = StockSnapshot.objects.filter(hotel=hotel, period=period).count()
        ...
        print(f"Total Items: {snapshot_count}")
        print(f"Total Value: €{grand_total:,.2f}")
        print(f"=" * 70)
    else:
        print(f"\n⚠️  Period NOT closed due to discrepancies")
