"""
Load Science questions into the database
True/False format questions about general science
"""
...
def load_science_questions():
    """Load Science questions from JSON file"""
    
    # Read the JSON file
    json_path = "science_questions.json"
    
    with open(json_path, 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    # Get or create Science category
    ...
    if created:
        print("✅ Created Science category")
    else:
        print("✅ Science category already exists")
    ...
    print("\n" + "=" * 70)
    print(f"✅ Successfully loaded {questions_created} Science questions")
...
if __name__ == '__main__':
    try:
        ...
        print(f"\n❌ Error loading science questions: {e}")
        import traceback
        traceback.print_exc()
