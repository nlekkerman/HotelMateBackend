"""
Script to load Art multiple-choice questions into the quiz system
"""
import os
import sys
import django
...
def load_art_questions():
    """Load Art questions from JSON file"""
    
    # Read the JSON file
    json_path = "art_questions.json"
    ...
    category, created = QuizCategory.objects.get_or_create(
        ...
        defaults={
            'name': 'Art',
            'description': 'Test your knowledge of art and literature',
            'icon': '🎨',
            'color': '#9333EA',
            'is_active': True,
            'display_order': 4
    ...
    if created:
        print("✅ Created Art category")
    else:
        print("✅ Art category already exists")
    ...
    print(f"🎨 Total Art questions in database: {total}")
    print(f"\n🎯 Art category is ready!")


if __name__ == '__main__':
    print("🔄 Loading Art questions...")
    load_art_questions()
    print("✅ Done!")
